...
```bash
npm test                 # 8/8 automated checks
npm run benchmark:exact  # 17,856 candidates -> 10,440 feasible, optimum confirmed
npm run dev              # launch the offline prototype at http://localhost:3000
```
...
| 05 | [Validation, results and reproducibility](05-validation-results-and-reproducibility.md) | 8/8 tests, exact benchmark, metric formulas |
